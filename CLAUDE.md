...
- **Seqera** (`seqeralabs/seqera` ~> 0.40): looks up credentials by name (`seqera_credentials`) and manages compute environments (`seqera_compute_env`). Requires Terraform >= 1.11 (write-only credential arguments).
